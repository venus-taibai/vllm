...
class DPEngineCoreProc(EngineCoreProc):
    ...
    def __init__(
        ...
        self.enable_inter_dp_scheduling = \
            vllm_config.additional_config.get('enable_inter_dp_scheduling',
                                              False)
            ...
            if "ASCEND_RT_VISIBLE_DEVICES" in os.environ:
                ...
                if device_ids == [""]:
                    msg = (
                        ...
                        " the environment variable `ASCEND_RT_VISIBLE_DEVICES` inside the"
                        " worker/actor. "
    ...
    def _handle_client_request(self, request_type: EngineCoreRequestType,
                               request: Any) -> None:
        logger.debug("handing client request, request_type = %s", request_type)
        if request_type == EngineCoreRequestType.START_DP_WAVE:
            new_wave, exclude_eng_index = request
            logger.debug("receive START_DP_WAVE , new_wave =%d, exclude_eng_index=%d, current_wave=%d", new_wave, exclude_eng_index, self.current_wave)
